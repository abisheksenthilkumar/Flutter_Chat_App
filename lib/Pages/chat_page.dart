...
import 'package:imessage/components/chat_bubble.dart';
import 'package:imessage/components/my_text_field.dart';
import 'package:imessage/services/chat/chat_service.dart';
...
class _ChatPageState extends State<ChatPage> {
  ...
  void sendMessage() async{
    // onlly send message if there is something to send
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [Text(data['senderEmail']),const SizedBox(height: 5), ChatBubble(message: data['message'])]),
      ),
    );
  }
